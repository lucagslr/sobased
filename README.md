...
> **État : phase 2 sur 14 terminée** (comptes, espaces, arbre de projets, droits et invitations). L'avancement réel est dans [PROGRESS.md](PROGRESS.md), l'explication de chaque phase dans [docs/phases/](docs/phases/).
