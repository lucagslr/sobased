...
ALLOWED = {
    ...
    "MyExportsView": "rows of request.user only",
    "MyExportDownloadView": "rows of request.user only",
    "DeleteAccountView": "acts on request.user only, password re-checked",
    ...
    "ExternalCalendarViewSet": "rows of the accounts of request.user only",
    "SyncNowView": "acts on request.user only",
    "SyncConflictsView": "rows of the accounts of request.user only",
    "ExternalEventsView": "rows of the calendars of request.user only",
    "GoogleCalendarWebhookView": "public, channel token checked, queues a task",
